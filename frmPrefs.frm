...
Begin VB.Form panzerPrefs 
   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":268C
            Left            =   1530
            List            =   "frmPrefs.frx":268E
            Style           =   2  'Dropdown List
            TabIndex        =   54
   ...
   Begin VB.Menu prefsMnuPopmenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Panzer Battery Widget"
      End
      Begin VB.Menu blank 
         Caption         =   "-"
      End
...
Private Sub chkDpiAwareness_Click()
    ...
    If prefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzBatteryGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzBatteryGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Panzer-Battery-Gauge-VB6\Panzer Battery Gauge.vbp"
...
'    End If
    ...
    If PzGStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzBatteryGaugeWidget", """" & App.path & "\" & "Panzer Battery Gauge.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzBatteryGaugeWidget", vbNullString)
    End If

    ' save the values from the general tab
    If fFExists(PzGSettingsFile) Then
        sPutINISetting "Software\PzBatteryGauge", "enableTooltips", PzGEnableTooltips, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "enableBalloonTooltips", PzGEnableBalloonTooltips, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "showTaskbar", PzGShowTaskbar, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
        
        
        sPutINISetting "Software\PzBatteryGauge", "gaugeSize", PzGGaugeSize, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "scrollWheelDirection", PzGScrollWheelDirection, PzGSettingsFile
                
        sPutINISetting "Software\PzBatteryGauge", "gaugeFunctions", PzGGaugeFunctions, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "pointerAnimate", PzGPointerAnimate, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "samplingInterval", PzGSamplingInterval, PzGSettingsFile
        
        
        'sPutINISetting "Software\PzBatteryGauge", "clockFaceSwitchPref", PzGClockFaceSwitchPref, PzGSettingsFile
'        sPutINISetting "Software\PzBatteryGauge", "mainGaugeTimeZone", PzGMainGaugeTimeZone, PzGSettingsFile
'        sPutINISetting "Software\PzBatteryGauge", "mainDaylightSaving", PzGMainDaylightSaving, PzGSettingsFile
        'sPutINISetting "Software\PzBatteryGauge", "secondaryGaugeTimeZone", PzGSecondaryGaugeTimeZone, PzGSettingsFile
        'sPutINISetting "Software\PzBatteryGauge", "secondaryDaylightSaving", PzGSecondaryDaylightSaving, PzGSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "aspectHidden", PzGAspectHidden, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "widgetPosition", PzGWidgetPosition, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "widgetLandscape", PzGWidgetLandscape, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "widgetPortrait", PzGWidgetPortrait, PzGSettingsFile

        sPutINISetting "Software\PzBatteryGauge", "prefsFont", PzGPrefsFont, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "clockFont", PzGClockFont, PzGSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "prefsFontSizeHighDPI", PzGPrefsFontSizeHighDPI, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "prefsFontSizeLowDPI", PzGPrefsFontSizeLowDPI, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "prefsFontItalics", PzGPrefsFontItalics, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "prefsFontColour", PzGPrefsFontColour, PzGSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzBatteryGauge", "windowLevel", PzGWindowLevel, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "preventDragging", PzGPreventDragging, PzGSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "opacity", PzGOpacity, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "hidingTime", PzGHidingTime, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "ignoreMouse", PzGIgnoreMouse, PzGSettingsFile
        
        
        sPutINISetting "Software\PzBatteryGauge", "startup", PzGStartup, PzGSettingsFile

        sPutINISetting "Software\PzBatteryGauge", "enableSounds", PzGEnableSounds, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "lastSelectedTab", PzGLastSelectedTab, PzGSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "debug", PzGDebug, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "dblClickCommand", PzGDblClickCommand, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "openFile", PzGOpenFile, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "defaultEditor", PzGDefaultEditor, PzGSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "clockHighDpiXPos", PzGClockHighDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "clockHighDpiYPos", PzGClockHighDpiYPos, PzGSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "clockLowDpiXPos", PzGClockLowDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "clockLowDpiYPos", PzGClockLowDpiYPos, PzGSettingsFile
...
'    cmbMainDaylightSaving.ListIndex = Val(PzGMainDaylightSaving)
    ...
    txtDefaultEditor.Text = PzGDefaultEditor
    lblGitHub.Caption = "You can find the code for the Panzer Battery Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/ Panzer-Battery-Gauge-VB6"
...
Private Sub fraConfigInner_MouseMove(Button As Integer, Shift As Integer, x As Single, Y As Single)
    If PzGEnableBalloonTooltips = "1" Then CreateToolTip fraConfigInner.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz gauge operates, configure them to suit your needs and your mode of operation.", _
...
Private Sub fraConfig_MouseMove(Button As Integer, Shift As Integer, x As Single, Y As Single)
    If PzGEnableBalloonTooltips = "1" Then CreateToolTip fraConfig.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz gauge operates, configure them to suit your needs and your mode of operation.", _
                  TTIconInfo, "Help on Configuration", , , , True
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Panzer-Battery-Gauge-VB6", vbNullString, App.path, 1)
    End If
...
'        sliAnimationInterval.ToolTipText = "Adjust to make the animation smooth or choppy. Any adjustment in the interval takes place instantly. Lower values are smoother but the smoother it runs the more Battery it uses."
...
'        cmbMainDaylightSaving.ToolTipText = "Select and activate Daylight Savings Time for your area."
        ...
        cmbTickSwitchPref.ToolTipText = "The movement of the hand can be set to smooth or regular flicks, the smooth movement uses slightly more Battery."
...
'    panzerPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\PzBatteryGauge", "skinTheme", PzGSkinTheme, PzGSettingsFile
