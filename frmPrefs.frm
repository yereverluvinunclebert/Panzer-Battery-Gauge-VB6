...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzBatteryGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
...
'    End If
    ...
    If fFExists(gblSettingsFile) Then
        sPutINISetting "Software\PzBatteryGauge", "enableTooltips", gblEnableTooltips, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "enableBalloonTooltips", gblEnableBalloonTooltips, gblSettingsFile
        ...
        sPutINISetting "Software\PzBatteryGauge", "gaugeFunctions", gblGaugeFunctions, gblSettingsFile
        ...
        'sPutINISetting "Software\PzBatteryGauge", "clockFaceSwitchPref", gblClockFaceSwitchPref, gblSettingsFile
'        sPutINISetting "Software\PzBatteryGauge", "mainGaugeTimeZone", gblMainGaugeTimeZone, gblSettingsFile
'        sPutINISetting "Software\PzBatteryGauge", "mainDaylightSaving", gblMainDaylightSaving, gblSettingsFile
        'sPutINISetting "Software\PzBatteryGauge", "secondaryGaugeTimeZone", gblSecondaryGaugeTimeZone, gblSettingsFile
        'sPutINISetting "Software\PzBatteryGauge", "secondaryDaylightSaving", gblSecondaryDaylightSaving, gblSettingsFile
        ...
        sPutINISetting "Software\PzBatteryGauge", "clockFont", gblClockFont, gblSettingsFile
        ...
        sPutINISetting "Software\PzBatteryGauge", "defaultEditor", gblDefaultEditor, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "clockHighDpiXPos", gblClockHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "clockHighDpiYPos", gblClockHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "clockLowDpiXPos", gblClockLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "clockLowDpiYPos", gblClockLowDpiYPos, gblSettingsFile
...
Private Sub fraConfigInner_MouseMove(Button As Integer, Shift As Integer, x As Single, Y As Single)
    If gblEnableBalloonTooltips = "1" Then CreateToolTip fraConfigInner.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz gauge operates, configure them to suit your needs and your mode of operation.", _
...
Private Sub fraConfig_MouseMove(Button As Integer, Shift As Integer, x As Single, Y As Single)
    If gblEnableBalloonTooltips = "1" Then CreateToolTip fraConfig.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz gauge operates, configure them to suit your needs and your mode of operation.", _
                  TTIconInfo, "Help on Configuration", , , , True
