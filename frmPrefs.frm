...
Begin VB.Form widgetPrefs 
   Caption         =   "Panzer Battery Gauge Preferences"
   ClientHeight    =   10545
   ClientLeft      =   60
   ClientTop       =   510
   ClientWidth     =   8880
   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":8623
            Left            =   1530
            List            =   "frmPrefs.frx":8625
            Style           =   2  'Dropdown List
            TabIndex        =   46
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin VB.Frame fraGeneralInner 
         ...
         Begin VB.ComboBox cmbTickSwitchPref 
            Height          =   315
            ItemData        =   "frmPrefs.frx":8A34
            Left            =   2010
            List            =   "frmPrefs.frx":8A36
            Style           =   2  'Dropdown List
            TabIndex        =   165
            Top             =   975
            Width           =   3720
...
Private pCmbCurrentAdapterBalloonTooltip As String
Private pCmbBatteryTrafficBalloonTooltip As String
Private pCmbMaxSpeedBalloonTooltip As String
...
Private Sub optGaugeTooltips_Click(Index As Integer)
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzBatteryGauge", "gaugeTooltips", gblGaugeTooltips, gblSettingsFile
...
Private Sub optPrefsTooltips_Click(Index As Integer)
   ...
   On Error GoTo optPrefsTooltips_Click_Error
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzBatteryGauge", "prefsTooltips", gblPrefsTooltips, gblSettingsFile
   ...
   On Error GoTo cmbMultiMonitorResize_Click_Error
    ...
    If cmbMultiMonitorResize.ListIndex = 2 Then
        If prefsMonitorStruct.IsPrimary = True Then
            ...
            sPutINISetting "Software\PzBatteryGauge", "gaugePrimaryHeightRatio", gblGaugePrimaryHeightRatio, gblSettingsFile
            
            'gblPrefsPrimaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzBatteryGauge", "prefsPrimaryHeightTwips", gblPrefsPrimaryHeightTwips, gblSettingsFile
        Else
            gblGaugeSecondaryHeightRatio = fGauge.gaugeForm.WidgetRoot.Zoom
            sPutINISetting "Software\PzBatteryGauge", "gaugeSecondaryHeightRatio", gblGaugeSecondaryHeightRatio, gblSettingsFile
            
            'gblPrefsSecondaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzBatteryGauge", "prefsSecondaryHeightTwips", gblPrefsSecondaryHeightTwips, gblSettingsFile
        End If
    End If
...
Private Sub Form_Load()
    ...
    Me.mnuAbout.Caption = "About Panzer Battery Gauge Cairo " & gblCodingEnvironment & " widget"
...
Private Sub initialisePrefsVars()
   ...
   On Error GoTo initialisePrefsVars_Error
    ...
    pCmbCurrentAdapterBalloonTooltip = vbNullString
    pCmbBatteryTrafficBalloonTooltip = vbNullString
    pCmbMaxSpeedBalloonTooltip = vbNullString
...
'        Case "cmbCurrentAdapter"
'            sTitle = "Help on Debug Mode"
'            sText = pCmbCurrentAdapterBalloonTooltip
'            If gblPrefsTooltips = "0" Then CreateToolTip cmbCurrentAdapter.hWnd, sText, , sTitle, , , , True
'        Case "cmbBatteryTraffic"
'            sTitle = "Help on Debug Mode"
'            sText = pCmbBatteryTrafficBalloonTooltip
'            If gblPrefsTooltips = "0" Then CreateToolTip cmbBatteryTraffic.hWnd, sText, , sTitle, , , , True
'        Case "cmbMaxSpeed"
'            sTitle = "Help on Debug Mode"
'            sText = pCmbMaxSpeedBalloonTooltip
'            If gblPrefsTooltips = "0" Then CreateToolTip cmbMaxSpeed.hWnd, sText, , sTitle, , , , True
...
Public Sub positionPrefsMonitor()
    ...
    If gblMonitorCount > 1 And LTrim$(gblMultiMonitorResize) = "2" Then
        ...
        If prefsMonitorStruct.IsPrimary = True Then
            gblPrefsFormResizedInCode = True
            gblPrefsPrimaryHeightTwips = fGetINISetting("Software\PzBatteryGauge", "prefsPrimaryHeightTwips", gblSettingsFile)
            ...
            End If
        Else
            gblPrefsSecondaryHeightTwips = fGetINISetting("Software\PzBatteryGauge", "prefsSecondaryHeightTwips", gblSettingsFile)
            gblPrefsFormResizedInCode = True
...
Private Sub chkDpiAwareness_Click()
    ...
    If pvtPrefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzBatteryGauge", "dpiAwareness", gblDpiAwareness, gblSettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Panzer-Battery-Gauge-VB6MkII\Panzer-Battery-Gauge-VB6.vbp"
...
'    End If
    ...
    If gblStartup = "1" Then
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PanzerBatteryGauge", """" & App.Path & "\" & "Panzer-Battery-Gauge-VB6.exe""")
    Else
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PanzerBatteryGauge", vbNullString)
    End If
    ...
    If fFExists(gblSettingsFile) Then
        ...
        sPutINISetting "Software\PzBatteryGauge", "showTaskbar", gblShowTaskbar, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "showHelp", gblShowHelp, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "dpiAwareness", gblDpiAwareness, gblSettingsFile
        
        
        sPutINISetting "Software\PzBatteryGauge", "gaugeSize", gblGaugeSize, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "scrollWheelDirection", gblScrollWheelDirection, gblSettingsFile
                
        sPutINISetting "Software\PzBatteryGauge", "widgetFunctions", gblGaugeFunctions, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "pointerAnimate", gblPointerAnimate, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "samplingInterval", gblSamplingInterval, gblSettingsFile
        
              
        sPutINISetting "Software\PzBatteryGauge", "aspectHidden", gblAspectHidden, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "widgetPosition", gblWidgetPosition, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "widgetLandscape", gblWidgetLandscape, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "widgetPortrait", gblWidgetPortrait, gblSettingsFile

        sPutINISetting "Software\PzBatteryGauge", "prefsFont", gblPrefsFont, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "gaugeFont", gblGaugeFont, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "prefsFontSizeHighDPI", gblPrefsFontSizeHighDPI, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "prefsFontSizeLowDPI", gblPrefsFontSizeLowDPI, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "prefsFontItalics", gblPrefsFontItalics, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "prefsFontColour", gblPrefsFontColour, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "displayScreenFont", gblDisplayScreenFont, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "displayScreenFontSize", gblDisplayScreenFontSize, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "displayScreenFontItalics", gblDisplayScreenFontItalics, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "displayScreenFontColour", gblDisplayScreenFontColour, gblSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzBatteryGauge", "windowLevel", gblWindowLevel, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "preventDragging", gblPreventDragging, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "opacity", gblOpacity, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "widgetHidden", gblWidgetHidden, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "hidingTime", gblHidingTime, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "ignoreMouse", gblIgnoreMouse, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "multiMonitorResize", gblMultiMonitorResize, gblSettingsFile
        
        
        sPutINISetting "Software\PzBatteryGauge", "startup", gblStartup, gblSettingsFile

        sPutINISetting "Software\PzBatteryGauge", "enableSounds", gblEnableSounds, gblSettingsFile
'        sPutINISetting "Software\PzBatteryGauge", "enableTicks", gblEnableTicks, gblSettingsFile
'        sPutINISetting "Software\PzBatteryGauge", "enableChimes", gblEnableChimes, gblSettingsFile
'        sPutINISetting "Software\PzBatteryGauge", "enableAlarms", gblEnableAlarms, gblSettingsFile
'        sPutINISetting "Software\PzBatteryGauge", "volumeBoost", gblVolumeBoost, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "lastSelectedTab", gblLastSelectedTab, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "debug", gblDebug, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "dblClickCommand", gblDblClickCommand, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "openFile", gblOpenFile, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "defaultVB6Editor", gblDefaultVB6Editor, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "defaultTBEditor", gblDefaultTBEditor, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "gaugeHighDpiXPos", gblGaugeHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "gaugeHighDpiYPos", gblGaugeHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzBatteryGauge", "gaugeLowDpiXPos", gblGaugeLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzBatteryGauge", "gaugeLowDpiYPos", gblGaugeLowDpiYPos, gblSettingsFile
...
'    chkVolumeBoost.Value = Val(gblVolumeBoost)
    ...
    lblGitHub.Caption = "You can find the code for the Panzer Battery Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/Panzer-Battery-Gauge"
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hWnd, "Open", "https://github.com/yereverluvinunclebert/Panzer-Battery-Gauge-" & gblCodingEnvironment, vbNullString, App.Path, 1)
    End If
...
Public Sub setPrefsTooltips()
   ...
   On Error GoTo setPrefsTooltips_Error
    ...
    If optPrefsTooltips(0).Value = True Then
        ...
        pCmbCurrentAdapterBalloonTooltip = "Identify your battery adapter beforehand using the battery panel on your system's settings or the control panel."
        pCmbBatteryTrafficBalloonTooltip = "By default both IN and OUT traffic will be monitored, you can select just received bytes input or those sent by the battery adapter, selected above."
        pCmbMaxSpeedBalloonTooltip = "Estimate the estimated maximum speed of this battery device (in Mbps). This setting will be adjusted automatically as the widget runs."
        pCmbTickSwitchPrefBalloonTooltip = "This sets the pointer from smooth to an instant flick mode"
...
'    widgetPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\PzBatteryGauge", "skinTheme", gblSkinTheme, gblSettingsFile
