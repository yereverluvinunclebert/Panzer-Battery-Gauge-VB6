...
Public Function fLicenceState() As Integer
    ...
    If fFExists(PzGSettingsFile) Then ' does the tool's own settings.ini exist?
        slicence = fGetINISetting("Software\PzBatteryGauge", "licence", PzGSettingsFile)
...
Public Sub readPrefsPosition()
   ...
   On Error GoTo readPrefsPosition_Error
    ...
    If PzGDpiAwareness = "1" Then
        PzGFormHighDpiXPosTwips = fGetINISetting("Software\PzBatteryGauge", "formHighDpiXPosTwips", PzGSettingsFile)
        PzGFormHighDpiYPosTwips = fGetINISetting("Software\PzBatteryGauge", "formHighDpiYPosTwips", PzGSettingsFile)
...
'        End If
    Else
        PzGFormLowDpiXPosTwips = fGetINISetting("Software\PzBatteryGauge", "formLowDpiXPosTwips", PzGSettingsFile)
        PzGFormLowDpiYPosTwips = fGetINISetting("Software\PzBatteryGauge", "formLowDpiYPosTwips", PzGSettingsFile)
   ...
   On Error GoTo writePrefsPosition_Error
    ...
    If panzerPrefs.WindowState = vbNormal Then ' when vbMinimised the value = -48000  !
        If PzGDpiAwareness = "1" Then
            ...
            sPutINISetting "Software\PzBatteryGauge", "formHighDpiXPosTwips", PzGFormHighDpiXPosTwips, PzGSettingsFile
            sPutINISetting "Software\PzBatteryGauge", "formHighDpiYPosTwips", PzGFormHighDpiYPosTwips, PzGSettingsFile
        Else
            PzGFormLowDpiXPosTwips = Str$(panzerPrefs.Left)
            PzGFormLowDpiYPosTwips = Str$(panzerPrefs.Top)
            
            ' now write those params to the toolSettings.ini
            sPutINISetting "Software\PzBatteryGauge", "formLowDpiXPosTwips", PzGFormLowDpiXPosTwips, PzGSettingsFile
            sPutINISetting "Software\PzBatteryGauge", "formLowDpiYPosTwips", PzGFormLowDpiYPosTwips, PzGSettingsFile
