...
Begin VB.Form menuForm 
   ...
   Begin VB.Menu mnuMainMenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Panzer Network Gauge Cairo widget"
      End
      ...
      Begin VB.Menu mnuHelpSplash 
         Caption         =   "Panzer Network Gauge One Page Help"
      End
...
Private Sub mnuAppFolder_Click()
   ...
   On Error GoTo mnuAppFolder_Click_Error
    ...
    Else
        MsgBox "Having a bit of a problem opening a folder for this widget - " & folderPath & " It doesn't seem to have a valid working directory set.", "Panzer Battery Gauge Confirmation Message", vbOKOnly + vbExclamation
        'MessageBox Me.hWnd, "Having a bit of a problem opening a folder for that command - " & sCommand & " It doesn't seem to have a valid working directory set.", "Panzer Battery Gauge Confirmation Message", vbOKOnly + vbExclamation
    End If
...
Public Sub mnuLatest_Click()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hWnd, "Open", "https://github.com/yereverluvinunclebert/Panzer-Battery-Gauge-" & gblCodingEnvironment & "/releases", vbNullString, App.Path, 1)
    End If
