...
Private Sub Form_Activate()
   ...
   On Error GoTo Form_Activate_Error
    ...
    gblMessageAHeightTwips = fGetINISetting("Software\PzBatteryGauge", "messageAHeightTwips", gblSettingsFile)
    gblMessageAWidthTwips = fGetINISetting("Software\PzBatteryGauge", "messageAWidthTwips ", gblSettingsFile)
...
Private Sub Form_Resize()
    ...
    sPutINISetting "Software\PzBatteryGauge", "messageAHeightTwips", gblMessageAHeightTwips, gblSettingsFile
    sPutINISetting "Software\PzBatteryGauge", "messageAWidthTwips", gblMessageAWidthTwips, gblSettingsFile
...
Public Property Let propTitle(ByVal newValue As String)
   On Error GoTo propTitle_Error
    ...
    If mPropTitle = "" Then
        Me.Caption = "Panzer-Battery-Gauge-" & gblCodingEnvironment & " Message."
    Else
