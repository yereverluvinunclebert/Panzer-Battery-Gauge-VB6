...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    widgetName = "Panzer Battery Gauge"
...
'        gblMainDaylightSaving = fGetINISetting(location, "mainDaylightSaving", gblSettingsFile)
        ...
        ' other
        gblClockHighDpiXPos = fGetINISetting("Software\PzBatteryGauge", "clockHighDpiXPos", gblSettingsFile)
        gblClockHighDpiYPos = fGetINISetting("Software\PzBatteryGauge", "clockHighDpiYPos", gblSettingsFile)
        
        gblClockLowDpiXPos = fGetINISetting("Software\PzBatteryGauge", "clockLowDpiXPos", gblSettingsFile)
        gblClockLowDpiYPos = fGetINISetting("Software\PzBatteryGauge", "clockLowDpiYPos", gblSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    gblSettingsDir = fSpecialFolder(feUserAppData) & "\PzBatteryGauge" ' just for this user alone
